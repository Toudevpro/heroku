...
ActiveRecord::Schema.define(version: 2019_02_04_125533) do
  ...
  create_table "tag_by_gossips", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["gossip_id"], name: "index_tag_by_gossips_on_gossip_id"
    t.index ["tag_id"], name: "index_tag_by_gossips_on_tag_id"
  end
